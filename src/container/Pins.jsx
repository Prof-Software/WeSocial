...
const Pins = ({ user,theme,switchtheme }) => {
  const [searchTerm, setSearchTerm] = useState('');

  return (
    <div className="px-2 md:px-5">
      <div className={`${theme=='dark' ? 'bg-[#121212]' : ' bg-gray-50'}`}>
        <Navbar switchtheme={switchtheme} theme={theme} searchTerm={searchTerm} setSearchTerm={setSearchTerm} user={user && user} />
      </div>
