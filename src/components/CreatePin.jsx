...
const CreatePin = ({ user,theme }) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5">
      ...
      <div className={`flex lg:flex-row flex-col justify-center items-center ${theme == 'dark' ? 'bg-[#181818]' :'bg-gray-50'} lg:p-5 p-3 lg:w-4/5  w-full`}>
        <div className={`${theme == 'dark' ? 'bg-[#090900]' :'bg-secondaryColor'} rounded-xl p-3 flex flex-0.7 w-full`}>
          <div className=" flex justify-center items-center flex-col border-2 rounded-xl border-dotted border-gray-300 p-3 w-full h-420">
            {loading && (
              <Spinner />
            )}
            {
        ...
        <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
          ...
          <input
            ...
            className={`${theme == 'dark' ? 'bg-[#181818]' :''} outline-none text-base sm:text-lg border-b-2 rounded-t-2xl border-gray-200 p-2`}
          />
          <input
            type="url"
            vlaue={destination}
            ...
            className={`outline-none ${theme == 'dark' ? 'bg-[#181818]' :''} rounded-t-2xl text-base sm:text-lg border-b-2 border-gray-200 p-2`}
          />
